...
*To use multi GPU training, use the ` torchrun -- nproc_per_node=8 train_rulti_GPU. py ` instruction, where the ` nproc_per_node ` parameter is the number of GPUs used
